...
const LessThan1lakh= () => {
  // Flatten the data and filter laptops with price less than or equal to 100000
  const lessthan50thousand = Object.values(Data).flat();
  const filteredData = lessthan50thousand.filter(
    (laptop) => laptop.price>50000 && laptop.price<=100000// Correct the price condition to <= 100000
  );
